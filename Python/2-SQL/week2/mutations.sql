...
-- A:Create a new categories table and a bridge table for a many-to-many relationship
...
ADD CONSTRAINT fk_ec_employees FOREIGN KEY (employee_id) REFERENCES employees(employee_id);
...
-- place it in the blank space below.
ALTER TABLE employees_categories
ADD CONSTRAINT fk_ec_categories FOREIGN KEY (category_id) REFERENCES categories(category_id);
